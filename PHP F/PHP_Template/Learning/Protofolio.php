...
<div class="container-fluid">
    </div><div class="Protofolio p-5 mt-5"  style="background-color: rgb(214, 223, 214);" class="container-fluid">
        <div class="container">
            <h1 style="color: darkcyan;" class="text-center">Protofolio</h1>
            ...
            <div class="row">
                <div class="text-center col-md-12">
                    <div style="border-radius: 50px;" class="mx-auto d-block bg-white w-25 shadow-lg p-4">
                        <b style="color: darkcyan;" class="ml-4">All</b>
                        <b id="b1" class="ml-4">App</b>
                        <b id="b2" class="ml-4">Card</b>
                        <b id="b3" class="ml-4">web</b>
                    </div>
                </div>
            </div>
            <div class="row">
